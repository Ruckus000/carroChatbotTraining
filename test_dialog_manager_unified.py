...
class TestDialogManagerUnified(unittest.TestCase):
    ...
    def test_full_towing_conversation_flow(self):
        ...
        print(f"PASS - Turn 1: Action type {action['type']} with slot {action['slot_name']}")
        ...
        state.required_slots = self.manager.define_required_slots("towing_request_tow_basic")
        ...
        print(f"PASS - Turn 2: Action type {action['type']} with slot {action['slot_name']}")
        ...
        print(f"PASS - Turn 3: Action type {action['type']} with slot {action['slot_name']}")
        ...
        print(f"PASS - Turn 5: Action type {action['type']}, booking confirmed: {state.booking_confirmed}")
