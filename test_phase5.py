...
class TestPhase5(unittest.TestCase):
    ...
    def test_obsolete_files_dont_exist(self):
        ...
        for file_path in obsolete_files:
            self.assertFalse(os.path.exists(file_path), f"Obsolete file {file_path} still exists")
    ...
    def test_obsolete_dirs_dont_exist(self):
        ...
        for dir_path in obsolete_dirs:
            self.assertFalse(os.path.exists(dir_path), f"Obsolete directory {dir_path} still exists")
    ...
    def test_requirements_file_content(self):
        ...
        for package in required_packages:
            self.assertIn(package, content, f"Required package {package} not in requirements.txt")
